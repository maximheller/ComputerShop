...
namespace NewComputerShop.Data
{
    ...
    public class ShopContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            User[] users =
                {
                new User{Id = 1, Name = "Maxim", Email="123@gmail.com", Password="password1"},
                new User{Id = 2, Name = "AlsoMaxim", Email="345@gmail.com", Password="password2"}
            ...
            Order[] orders =
            {
                new Order{Id = 1, UserId = 1, CreatedDate = DateTime.Now, Paid = true },
                new Order{Id = 2, UserId = 1, CreatedDate = DateTime.MaxValue, Paid = false }
